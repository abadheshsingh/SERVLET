...
@WebServlet(name = "JTCLOGIN", urlPatterns = {"/test1.jtc"},
	initParams = {@WebInitParam(name = "email", value = "kumarabadhesh1008@gmail.com"  ),
			@WebInitParam(name = "phone", value = "9312030007")})
public class JtcServlet1 extends HttpServlet {
